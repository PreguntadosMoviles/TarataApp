...
class SenderismoScreen extends StatelessWidget {
  @override
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          RutaScreen()), // Asegúrate de que RutaScreen esté definido en ruta.dart
                );
              },
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          ParqueFerialScreen()), // Asegúrate de que JuegosScreen esté definido en juegos.dart
                );
              },
